                ...
                <div class="card-body p-0">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            @endif
                            <div class="p-5">
                                <form class="user py-2" action="/login" method="post">
                                    @csrf
                                    <div class="form-group mb-2">
                                        <input type="email" name="email" class="form-control form-control-user" id="email" placeholder="Enter Email Address" value="{{ old('email')}}">
                                        @error('email')
